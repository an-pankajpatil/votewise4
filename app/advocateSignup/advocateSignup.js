'use strict';
angular.module('myApp.advocateSignup', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/advocatesignup', {
    templateUrl: 'advocateSignup/advocateSignup.html',
    controller: 'advocateSignupCtrl'
  });
}])

.controller('advocateSignupCtrl', ['$scope','$http','$location','apiCall', function ($scope, $http, $location, apiCall) {
  $scope.user = {};
