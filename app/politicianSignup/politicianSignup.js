'use strict';
angular.module('myApp.politicianSignup', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/politiciansignup', {
    templateUrl: 'politicianSignup/politicianSignup.html',
    controller: 'politicianSignupCtrl'
  });
}])

.controller('politicianSignupCtrl', ['$scope','$http','$location','apiCall', function ($scope, $http, $location, apiCall) {
  $scope.user = {};
